from builtins import hasattr, tuple, type
...
for model_name, model in app.models.items():
    ...
    model_admin.list_filter = model.admin_list_filter if hasattr(model,
                                                                 'admin_list_filter') else model_admin.list_display
